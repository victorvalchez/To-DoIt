...
const handleRequest = async (request, response) => {
    ...
    if(request.method === "GET"){
        ...
        switch(url){
            case "/":
            case "/index.html":
                content = await serveStaticFile("/lab2_r/www/index.html");
                contentType = "text/html";
                break;
            case "/script.js":
                content = await serveStaticFile("/lab2_r/www/script.js");
                contentType = "text/javascript";
                break;
            case "/style.css":
                content = await serveStaticFile("/lab2_r/www/style.css");
                contentType = "text/css";
                break;
            case "/tasks.json":
                content = await serveStaticFile("/lab2/tasks.json");
